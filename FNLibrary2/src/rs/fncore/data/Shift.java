...
public class Shift extends Document {
	 ...
	 * @return
	 */
	public OFDStatistic getOFDStatistic() { return _ofdState; }
	/**
	 * Открыта ли смена
	 * @return
	 */
	 ...
	 * @return
	 */
	public int getNumber() { return _shift_number; }
	/**
	 * Номер последнего документа в смене если смена открыта, количество документов за смену если закрыта
	 * @return
	 */
	public int getLastDocumentNumber() { return _last_doc_number; }
	/**
	 * Когда открыта смена
	 * @return
	 */
	public long getWhenOpen() { return _when_open; }
	/**
	 * Флаги предупреждений ФН
	 * @return
	 */
	public int getFNWarnings() { return _warnings; }

...
public class Signer implements Parcelable {
	...
	public String DeviceSerial() { return _device_serial; }
	/**
	 * Заводской номер ККМ
	 * @return
	 */
	public String KKMNumber() { return _kkm_number; }
	/**
	 * Серийный номер фискального накопителя
	 * @return
	 */
	public String FNNumber() { return _fn_number; }
	/**
	 * Владелец ККМ
	 * @return
	 */
	public OU owner() { return _owner; }
	/**

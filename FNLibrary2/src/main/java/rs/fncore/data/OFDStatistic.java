...
public class OFDStatistic implements IReableFromParcel {
	 ...
	 * @return
	 */
	public boolean haveUnsentDocuments() { return _documentCount > 0; }
	/**
	 * Количество неотправленных документов
	 * @return
	 */
	public int getDocumentCount() { return _documentCount; }
	/**
	 * Номер первого неотправленного документа
	 * @return
	 */
	public int getFirstUnsentNumber() { return _firstUnsentNumber; }
	/**
	 * Дата первого неотправленного документа
	 * @return
	 */
	public long getFirstUnsentDate() { return _firstUnsentDate; }
	@Override
